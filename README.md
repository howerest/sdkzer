## 0.5.0-rc.1 Release candidate available ##
...
# Full API docs
Current v0.5.0-rc.1 - [Read full API docs](http://www.howerest.com/sdkzer/docs/0.5.0-rc.1-rc/classes/_howerest_sdkzer_.sdkzer.html)
