## 0.6.0-rc.1 Release candidate available ##
...
# Full API docs
Current v0.6.0-rc.1 - [Read full API docs](http://www.howerest.com/sdkzer/docs/0.1.0-rc/classes/_howerest_sdkzer_.sdkzer.html)
